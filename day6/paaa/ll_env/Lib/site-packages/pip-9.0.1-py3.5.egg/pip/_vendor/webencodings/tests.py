...
def test_iter_decode():
    ...
    assert iter_decode_to_string([
        b'', b'h\xe9', b'llo'], 'x-conf-defined') == 'h\uF7E9llo'
...
def test_iter_encode():
    ...
    assert b''.join(iter_encode([
        '', 'h\uF7E9', '', 'llo'], 'x-conf-defined')) == b'h\xe9llo'
...
def test_x_user_defined():
    ...
    encoded = b'aa'
    decoded = 'aa'
    assert decode(encoded, 'x-conf-defined') == (decoded, lookup('x-conf-defined'))
    assert encode(decoded, 'x-conf-defined') == encoded
