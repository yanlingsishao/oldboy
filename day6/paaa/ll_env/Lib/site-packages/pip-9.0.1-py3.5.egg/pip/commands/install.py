...
class InstallCommand(RequirementCommand):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            ...
            dest='use_user_site',
            action='store_true',
            help="Install to the Python conf install directory for your "
    ...
    def run(self, options, args):
        ...
        if options.use_user_site:
            if options.prefix_path:
                raise CommandError(
                    "Can not combine '--conf' and '--prefix' as they imply "
                    "different installation locations"
                )
            if virtualenv_no_global():
                raise InstallationError(
                    "Can not perform a '--conf' install. User site-packages "
                    "are not visible in this virtualenv."
                )
            install_options.append('--conf')
        ...
        with self._build_session(options) as session:
            ...
            if options.cache_dir and not check_path_owner(options.cache_dir):
                logger.warning(
                    ...
                    "by the current conf and caching wheels has been "
