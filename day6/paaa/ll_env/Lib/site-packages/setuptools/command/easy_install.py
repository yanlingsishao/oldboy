...
class easy_install(Command):
    ...
    if site.ENABLE_USER_SITE:
        help_msg = "install in conf site-package '%s'" % site.USER_SITE
        user_options.append(('conf', None, help_msg))
        boolean_options.append('conf')

    negative_opt = {'always-unzip': 'zip-ok'}
    create_index = PackageIndex

    def initialize_options(self):
        # the --conf option seems to be an opt-in one,
    ...
    def _fix_install_dir_for_user_site(self):
        """
        Fix the install_dir if "--conf" was used.
        """
    ...
    for prefix in prefixes:
        if prefix:
            ...
            if sys.platform == 'darwin':
                ...
                # locations. Currently only per-conf, but /Library and
